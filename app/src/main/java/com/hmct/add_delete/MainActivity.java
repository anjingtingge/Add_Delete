...
import com.hmct.add_delete.Fragment.MyFragment_add_hand;
import com.hmct.add_delete.Fragment.MyFragment_recipe;
...
//    private void initID(){
//        detal_layout_cang = findViewById(R.id.tag_layoutcang);
//        detal_layout_bian=findViewById(R.id.tag_layoutbianwen);
//        detal_layout_dong=findViewById(R.id.tag_layoutlengdong);
//
//        mTagLayout = (FlowLayout) findViewById(R.id.tag_layout);
//        mTagLayout_bian = findViewById(R.id.tag_layoutbian);
//        mTagLayout_dong = findViewById(R.id.tag_layoutdong);
//        getmTagLayout_usual=findViewById(R.id.tag_usual);
//        textView_bian=findViewById(R.id.textview_bian);
//        textView_dong=findViewById(R.id.textview_dong);
//        textView_cang=findViewById(R.id.textview_cang);
//        imageView_add=findViewById(R.id.image_add);
//
//    }
...
//        //弹出食材详情
//        popView=LayoutInflater.from(MainActivity.this).inflate(R.layout.material_detail, null);
...
//
//        //冷藏区域点击
//        mTagLayout.setOnClickListener(new OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
//
...
//
//        //变温区域点击
//        mTagLayout_bian.setOnClickListener(new OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
//
...
//
//        //冷冻区域点击
//        mTagLayout_dong.setOnClickListener(new OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
//
...
//
//                            final View view_dialog = View.inflate(MainActivity.this, R.layout.dialog, null);
...
//            final int pos = i;
//
//            final View view_bian = (View) LayoutInflater.from(MainActivity.this).inflate(R.layout.text_view, mTagLayout_bian, false);
//
...
//
//            //设置    单击事件：
//            icon_bian.setOnClickListener(new OnClickListener() {
//
//                @Override
//                public void onClick(View v) {
//                    //遍历  图标  删除 当前  被点击项
...
//
//            final int finalI = i;
//            frameLayout_bian.setOnClickListener(new OnClickListener() {
//
//                @Override
//                public void onClick(View v) {
//                    //弹出食材详情,popview
...
//            final int pos = i;
//
//            final View view = (View) LayoutInflater.from(MainActivity.this).inflate(R.layout.text_view, mTagLayout_dong, false);
//
//            final TextView text = (TextView) view.findViewById(R.id.text);  //查找  到当前     textView
//            final TextView freshday_cang = (TextView) view.findViewById(R.id.freshday);  //查找  到当前     textView
//
...
//
//            final int finalI = i;
//            frameLayout_dong.setOnClickListener(new OnClickListener() {
//
//                @Override
//                public void onClick(View v) {
//                    //弹出食材详情,popview
...
//            final int pos = i;
//
//            final View view = (View) LayoutInflater.from(MainActivity.this).inflate(R.layout.text_view, getmTagLayout_usual, false);
//
//            final TextView text = (TextView) view.findViewById(R.id.text);  //查找  到当前     textView
//            final TextView icon = (TextView) view.findViewById(R.id.delete_icon);  //查找  到当前  删除小图标
//            final ImageView imageView=view.findViewById(R.id.image);
...
//    }
    ...
    private MyFragment_add_hand fg0;
    private MyFragment_recipe fg1;
    private FragmentManager fManager;
    private MyBtnClicker myBtnClicker = new MyBtnClicker();
    private TextView textView_hand_add,textView_recipe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_hand_add= (TextView) findViewById(R.id.textview_hand_add);
        textView_recipe=(TextView) findViewById(R.id.textview_recipe);

        textView_hand_add.setOnClickListener(myBtnClicker);
        textView_recipe.setOnClickListener(myBtnClicker);
        fManager = getFragmentManager();
        FragmentTransaction fTransaction = fManager.beginTransaction();
        textView_hand_add.performClick();   //模拟一次点击，既进去后选择第一项
    }

    //重置所有文本的选中状态
    private void setSelected(){
        textView_hand_add.setSelected(false);
        textView_recipe.setSelected(false);
    ...
    private class MyBtnClicker implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case R.id.textview_hand_add:
                    textView_hand_add.setBackgroundResource(R.drawable.textview_border);
                    textView_recipe.setBackgroundResource(R.drawable.textview_boder_bottom);
                    setSelected();
                    textView_hand_add.setSelected(true);

                    if(fg0 == null){
                        fg0 = new MyFragment_add_hand();
                ...
                case R.id.textview_recipe:
                    textView_hand_add.setBackgroundResource(R.drawable.textview_boder_bottom);
                    textView_recipe.setBackgroundResource(R.drawable.textview_boder_lefttop);

                    setSelected();
                    textView_recipe.setSelected(true);
                    if(fg1 == null){
                        fg1 = new MyFragment_recipe();
